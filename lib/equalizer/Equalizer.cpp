...
void Equalizer::Pass::Process(const float in, float &out) {
	out = a0 * in + a1 * xm1 + a2 * xm2 + a3 * xm3 + a4 * xm4 -
...
void Equalizer::Split(float* data, float* low, float* mid,
					  float* high, unsigned int length,
